...
description: Gallery of Still Life paintings by French artist Nicolas Watine
og-title:
og-description:
og-image:
body-id: still-life
...
<div class="sticky-container" data-sticky-container>
	<div class="sticky" data-sticky-on="small" data-sticky data-top-anchor="350" data-margin-top="0" style="width: 100%;">
		<div class="row galleryNav">
			<div class="columns">
				<h1 class="galleryTitle white serif margin-0">Still Life</h1>
				...
				<nav class="categoryNav" id="categoryMenu">
					<ul class="vertical medium-horizontal menu">
						...
						<li class="caps"><a class="active" href="/eng/paintings/still-life">Still Life</a></li>
	...
	<div class="column">
		<div class="artCard">
			...
			<div class="artCard-prose">
				...
				<p class="dimensions">50 x 61 cm</p>
			</div>
		</div>
	</div>
	<div class="column">
